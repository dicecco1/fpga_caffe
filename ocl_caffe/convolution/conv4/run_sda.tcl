...
create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv3
create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv4
create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv5
create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv6
#create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv7
#create_compute_unit -opencl_binary [get_opencl_binary conv4_layer] -kernel [get_kernels conv4_layer] -name ocl_conv8
