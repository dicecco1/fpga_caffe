...
create_solution -name prj_ocl_conv5 -dir . -force
...
# Host Source Files
add_files "main.c"
add_files "conv5_layer.h"
set_property file_type "c header files" [get_files "conv5_layer.h"]

# Kernel Definition
create_kernel conv5_layer -type clc
...
run_emulation -flow cpu -args "conv5_layer.xclbin"
