...
#create_compute_unit -opencl_binary [get_opencl_binary conv3_layer] -kernel [get_kernels conv3_layer] -name ocl_pooling3
#create_compute_unit -opencl_binary [get_opencl_binary conv3_layer] -kernel [get_kernels conv3_layer] -name ocl_pooling4
