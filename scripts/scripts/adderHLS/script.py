...
for exponent in range (4,8):
	for mentisa in range (4,21):
		...
		directory = '/home/linsun/Desktop/chalfHLS/adderHLS/impl_reports'
		second_directory = '/home/linsun/Desktop/chalfHLS/adderHLS/report1'
		third_directory = '/home/linsun/Desktop/chalfHLS/adderHLS/report2'
		...
		if __debug__:
			...
			copyfile('/home/linsun/Desktop/chalfHLS/adderHLS/adders_prj/solution1/impl/report/verilog/adders_export.rpt', '/home/linsun/Desktop/chalfHLS/adderHLS/impl_reports/temp_report.rtp')
...
ax.text(12,6.6,450,'First')
ax.text(12,4.3,450,'Second')
ax.text(12,2.5,450,'Third')
ax.text(12,0.25,450,'Average')
ax.legend()
plt.show()

# information regarding single precision comparison HLS result
...
# #=== Final timing ===
# CP required:    4.000
# CP achieved post-synthesis:    3.563
# CP achieved post-implemetation:    3.472
# Timing met