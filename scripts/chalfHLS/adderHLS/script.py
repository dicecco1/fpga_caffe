...
for exponent in range (4,8):
	for mentisa in range (2,15):
		...
		if __debug__:
			...
			copyfile('/home/lin/Desktop/chalfHLS/adderHLS/adders_prj/solution1/impl/report/verilog/adders_export.rpt', '/home/lin/Desktop/chalfHLS/adderHLS/impl_reports/temp_report.rtp')
			for file in os.listdir(directory):
				if file.startswith("temp_report"):
					# rename the report with the exponent and mentissa used
...
csv_f = open('adders_round.csv', 'wt')
writer = csv.writer(csv_f)
writer.writerow(('Adders', 'Round-to-Nearest'))
