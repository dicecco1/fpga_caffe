...
for exponent in range (4,8):
	for mentisa in range (2,15):
		...
		directory = '/home/lin/Desktop/chalfHLS/mulHLS_roundOFF/impl_reports'
		...
		if __debug__:
			...
			copyfile('/home/lin/Desktop/chalfHLS/mulHLS_roundOFF/mul_prj/solution1/impl/report/verilog/mul_export.rpt', '/home/lin/Desktop/chalfHLS/mulHLS_roundOFF/impl_reports/temp_report.rtp')
		...
		with open(os.path.join(directory, reportname)) as f:
			for line in f:
				...
				if 'CP achieved post-synthesis' in line:
					print 'now ' + str(exponent) + ' ' + str(mentisa)
					CP_achieved_post_synthesis = data[3].lstrip().rstrip()
...
csv_f = open('mul_round_off.csv', 'wt')
writer = csv.writer(csv_f)
writer.writerow(('Multiplication', 'Round-to-Zero'))
