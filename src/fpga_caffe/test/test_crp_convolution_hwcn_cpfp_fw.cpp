...
class CRPConvolutionFWHWCNCPFPTest : public OCLDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;

 protected:
  CRPConvolutionFWHWCNCPFPTest()
  ...
  virtual ~CRPConvolutionFWHWCNCPFPTest() {}
...
TYPED_TEST_CASE(CRPConvolutionFWHWCNCPFPTest, TestOCLDtypesAndDevices);

TYPED_TEST(CRPConvolutionFWHWCNCPFPTest, TestConvReLU1x1FOnly_CPFP) {
  this->ocl.Setup();
