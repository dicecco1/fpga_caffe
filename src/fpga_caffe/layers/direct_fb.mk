...
SDA_FLOW = cpu_emu
XOCC = xocc
KERNEL_SRCS = conv_layer_direct_fb.cpp
KERNEL_NAME = conv_layer_direct_fb
NK = 1

DSA = xilinx:adm-pcie-8k5:2ddr:3.2

XCLBIN_NAME=conv_layer_direct_fb
...
XCL_OPT += --platform ${DSA} --report estimate --nk ${KERNEL_NAME}:${NK} --kernel ${KERNEL_NAME} -I ${INCLUDE_DIR} -o ${XCLBIN}
