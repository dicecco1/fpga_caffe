...
template <typename Dtype>
void OCLConvolutionLayer<Dtype>::backward_bias(const vector<Blob<Dtype>*>& top,
...
template <typename Dtype>
void OCLConvolutionLayer<Dtype>::backward_data(const vector<Blob<Dtype>*>& top,
    const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
...
template <typename Dtype>
void OCLConvolutionLayer<Dtype>::backward_weights(const vector<Blob<Dtype>*>& top,
    const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
  kernel_params *params = &ocl_params_bi_;
